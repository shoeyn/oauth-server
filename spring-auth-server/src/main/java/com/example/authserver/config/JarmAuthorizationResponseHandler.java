 ...
 * Prevents response parameter tampering, code injection, and replay via cryptographic binding.
 */
@Slf4j
...
public class JarmAuthorizationResponseHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(
    ...
    log.info(
        "RFC 9221 JARM: Signed authorization response issued to client '{}' at '{}'",
        clientId,
        redirectUri);
