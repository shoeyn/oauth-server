...
/**
 * AWS KMS Client Configuration with Enterprise Resilience & High-Availability Tuning. Configured
 * with exponential backoff and full jitter for handling transient connection hiccups.
 */
  ...
  public KmsClient kmsClient() {
    ...
    ClientOverrideConfiguration overrideConfig =
        ClientOverrideConfiguration.builder()
            .retryStrategy(
                AwsRetryStrategy.standardRetryStrategy().toBuilder().maxAttempts(3).build())
