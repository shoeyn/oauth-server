...
public final class ParEndpointUtils {
   ...
   */
  public static OAuth2AuthorizationRequest resolveAuthRequest(
      String requestUri, OAuth2AuthorizationService authorizationService) {
    if (!StringUtils.hasText(requestUri) || authorizationService == null) {
      return null;
    }
    String stateToken =
        requestUri.startsWith(PAR_REQUEST_URI_PREFIX)
